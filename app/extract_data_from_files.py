...
solvents_area_height_A = {j: [find_solvent_data(i, j) for i in sorted(collected_A_files, key=len)] for j in solvents}
solvents_area_height_B = {j: [find_solvent_data(i, j) for i in sorted(collected_B_files, key=len)] for j in solvents}
